...
public interface IVenueService
{
    ...
    Task<Guid> CreateAsync(string name, string? phone, string? address, int rounds, bool allowsPets, CancellationToken ct);
    Task UpdateAsync(Guid id, string name, string? phone, string? address, bool allowsPets, int rounds, CancellationToken ct);
