...
export default function CreateVenueDialog({opened, onClose,rowData,onEdited}){
  ...
  useEffect(() => {
    ...
    const handleSubmit = async() =>{
        ...
        try{
            ...
            await usersApi.edit(rowData.id,dto);
            onEdited?.(); //parent to fetch list
            reset();
            onClose?.();
